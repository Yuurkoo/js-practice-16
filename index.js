...
function logArrayElements(arr) {
  ...
  const sortedArr = arr.map((key, value) => {
    console.log(`Елемент ${value} :`, key);
  });
  return sortedArr;
}
...
// можливо моя версія віжуал(стара) не підтримує console.assert(), бо спрацювали тільки .log
...
function buildMatrix(size) {
  ...
  if (typeof size !== "number") {
    return "Аргумент має бути числом!";
  }
...
function validateUserInput(userInput) {
  ...
  if (userInput.name === "undefined") {
    return "Помилка: ім'я користувача відсутнє!";
  }

  if (userInput.password === "undefined") {
    return "Помилка: пароль відсутній!";
  }
...
function calculateTotalPrice(products) {
  ...
  console.log("Час виконання коду: " + time + " секунд");
}
